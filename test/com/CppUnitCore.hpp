#ifndef __OPENGEOPP_CPPUNITCORE_HPP
#define __OPENGEOPP_CPPUNITCORE_HPP
...
int main (int argc, char* argv[]) {  \
  ...
  return OPENGEOPP::CppUnitCore (xmlOutputFile.c_str()).main(argc, argv); \
}
// /////////// (END OF)  MACROS /////////////
...
#endif // __OPENGEOPP_CPPUNITCORE_HPP
