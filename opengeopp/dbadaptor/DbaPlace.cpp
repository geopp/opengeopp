...
#include <exception>
// OpenGeopp
#include <opengeopp/bom/Place.hpp>
#include <opengeopp/dbadaptor/DbaPlace.hpp>
#include <opengeopp/service/Logger.hpp>

namespace soci {

  // //////////////////////////////////////////////////////////////////////
  void type_conversion<OPENGEOPP::Place>::
  from_base (values const& iPlaceValues, indicator /* ind */,
    ...
    /*
      ...
      classical_name, classical_name2, extended_name, alternate_name1,
      alternate_name2, alternate_name3, alternate_name4, alternate_name5,
      alternate_name6, alternate_name7, alternate_name8, alternate_name9,
      alternate_name10      
    */
    ...
    if (lLanguageString.empty() == true) {
      throw new OPENGEOPP::LanguageCodeNotDefinedInNameTableException();
    }

    const OPENGEOPP::Language::EN_Language lLanguageCode =
      OPENGEOPP::Language::getCode (lLanguageString);

    const std::string& lClassicalName =
      iPlaceValues.get<std::string> ("classical_name", "");
    ioPlace.addName (lLanguageCode, lClassicalName);

    const std::string& lClassicalName2 =
      iPlaceValues.get<std::string> ("classical_name", "");
    ioPlace.addName (lLanguageCode, lClassicalName2);
  ...
  // //////////////////////////////////////////////////////////////////////
  void type_conversion<OPENGEOPP::Place>::
  to_base (const OPENGEOPP::Place& iPlace, values& ioPlaceValues,
